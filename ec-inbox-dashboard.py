...
# DEFAULT FILE LOAD
# =========================================================
DEFAULT_FILE = "ECInbox_Analysis_20251201.xlsx"
...
df["Chatbot_Addressable"] = (
    ...
    .str.lower()               # Lowercase
    .map({"yes": True, "y": True, "true": True, "no": False, "n": False, "false": False})
    .fillna(False)             # Anything else treated as False
)
...
chatbot_count = filtered_df["Chatbot_Addressable"].sum()  # True counts as 1
